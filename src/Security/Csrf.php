...
final class Csrf
{
    ...
    {
        return (string)($_POST[self::tokenName()] ?? $_SERVER['HTTP_X_CSRF_TOKEN'] ?? '');
    }
    ...
    public static function field(): string
    {
        ...
        return sprintf(
            ...
            htmlspecialchars(self::tokenName(), ENT_QUOTES, 'UTF-8'),
    ...
    {
        return defined('CSRF_TOKEN_NAME') ? (string) CSRF_TOKEN_NAME : '_csrf_token';
    }
    ...
    private static function respondInvalidToken(): never
    {
        ...
        echo '<!doctype html><html lang="id"><head><meta charset="utf-8"><title>Invalid CSRF token</title>'
            ...
            . '<div class="box"><strong>Apa artinya?</strong><br>' . htmlspecialchars(self::EXPLANATION, ENT_QUOTES, 'UTF-8') . '</div>'
            . '<div class="box"><strong>Apa yang harus dilakukan?</strong><ul>'
            . '<li>' . htmlspecialchars(self::ACTIONS[0], ENT_QUOTES, 'UTF-8') . '</li>'
            . '<li>' . htmlspecialchars(self::ACTIONS[1], ENT_QUOTES, 'UTF-8') . '</li>'
            . '<li>' . htmlspecialchars(self::ACTIONS[2], ENT_QUOTES, 'UTF-8') . '</li>'
            . '</ul></div>'
