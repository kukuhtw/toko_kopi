...
{
    public const PLUGIN_SLUG = 'rajaongkir-delivery';
    ...
    public function ensureSchema(): void
    {
        ...
        $this->ensureColumn('orders', 'delivery_etd', 'VARCHAR(50) DEFAULT NULL AFTER delivery_service');
        $this->ensureColumn('orders', 'delivery_destination_id', 'VARCHAR(50) DEFAULT NULL AFTER delivery_etd');
