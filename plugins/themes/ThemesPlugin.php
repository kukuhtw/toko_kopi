...
class ThemesPlugin implements PluginInterface
{
    ...
    public function injectStyles(string $html): string
    {
        ...
        $lines[] = '.sidebar-tagline{font-size:.68rem;color:rgba(255,255,255,.45);margin-top:3px;font-weight:400;letter-spacing:.3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:196px;}';
