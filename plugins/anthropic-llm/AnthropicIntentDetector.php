...
- Requests such as "jelaskan", "detail", "info", "deskripsi", "ceritakan", "apa itu" about catalog items = tanya_menu
- Requests such as "recommend", "rekomendasi", "sarankan" = tanya_menu
- Do NOT classify a catalog explanation request as out_of_scope just because the message is long
...
SYS;
    ...
    public function detectAll(string $message, array $context = []): array
    {
        ...
        try {
            ...
            error_log('[AnthropicIntentDetector] detectAll: ' . $e->getMessage());
        }
